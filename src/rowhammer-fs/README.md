---
title: Base Linux x86-ubuntu and arm-ubuntu image with Ubuntu 22.04
shortdoc: >
    Resources to build a generic x86-ubuntu disk image with rowhammer resources, mostly for HammerSim.
    This resource is based on ubuntu generic by Harshil Patel.
authors: ["kg"]
---

The disk image currently only supports x86 ubuntu architecture to run rowhammer-test (by google) and Blacksmith (from ETH Zurich) in a full system environment.
