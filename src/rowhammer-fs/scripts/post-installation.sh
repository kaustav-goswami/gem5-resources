...
echo "Building rowhammer stuff before we loose root access!"

echo "a. rowhammer-test"
cd /home/gem5
...
echo "b. blacksmith using madvise pages"
git clone https://github.com/kaustav-goswami/blacksmith.git
cd blacksmith
git checkout blacksmith-gem5
mkdir build
cd build
cmake ..
make -j8
...
echo "all rowhammer artifacts built!"
